(define (domain 'domain-problem')
  ...
  (:action clean_0_a1
    ...
    :effect
      (and
        (oneof (and (not (current_state_0 s0_a1)) (current_state_0 s0_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action clean_1_b0
    ...
    :effect
      (and
        (oneof (and (not (current_state_1 s1_b0)) (current_state_1 s1_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action clean_1_b1
    ...
    :effect
      (and
        (oneof (and (not (current_state_1 s1_b1)) (current_state_1 s1_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action clean_1_b2
    ...
    :precondition 
      (and
        (current_state_1 s1_b2)
        (f_ok)
        (f_world))
    :effect
      (and
        (oneof (and (not (current_state_1 s1_b2)) (current_state_1 s1_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action clean_2_c0
    ...
    :effect
      (and
        (oneof (and (not (current_state_2 s2_c0)) (current_state_2 s2_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action clean_2_c1
    ...
    :effect
      (and
        (oneof (and (not (current_state_2 s2_c1)) (current_state_2 s2_sink)))
        (last_action clean)
        (f_copy)
        (not 
          (last_action empty))
  ...
  (:action empty_0_a0
    ...
    :effect
      (and
        (oneof (and (not (current_state_0 s0_a0)) (current_state_0 s0_sink)))
        (last_action empty)
        (f_copy)
        (not 
          (last_action clean))
  ...
  (:action empty_0_a1
    ...
    :effect
      (and
        (oneof (and (not (current_state_0 s0_a1)) (current_state_0 s0_a0)))
        (last_action empty)
        (f_copy)
        (not 
          (last_action clean))
  ...
  (:action empty_1_b1
    ...
    :effect
      (and
        (oneof (and (not (current_state_1 s1_b1)) (current_state_1 s1_b0)))
        (last_action empty)
        (f_copy)
        (not 
          (last_action clean))
  ...
  (:action empty_2_c1
    ...
    :effect
      (and
        (oneof (and (not (current_state_2 s2_c1)) (current_state_2 s2_c0)))
        (last_action empty)
        (f_copy)
        (not 
          (last_action clean))
  ...
  (:action pluck_2_c0
    ...
    :effect
      (and
        (oneof (and (not (current_state_2 s2_c0)) (current_state_2 s2_c1)))
        (last_action pluck)
        (f_copy)
        (not 
          (last_action clean))
