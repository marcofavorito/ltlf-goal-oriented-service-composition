(define (problem problem)
  ...
  (:objects s0_rotor_builder_0 - state s0_rotor_builder_broken - state s1_stator_builder_0 - state s1_stator_builder_broken - state s2_inverter_builder_0 - state s2_inverter_builder_broken - state s3_motor_assembler_0 - state s3_motor_assembler_broken - state s4_mechanical_engineer_1_0 - state s4_mechanical_engineer_1_broken - state s5_mechanical_engineer_2_0 - state)
  (:init 
